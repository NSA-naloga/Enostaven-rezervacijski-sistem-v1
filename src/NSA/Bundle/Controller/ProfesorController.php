...
use NSA\Bundle\Form\ProfesorType;
...
class ProfesorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NSABundle:Profesor')->findAll();
     ...
     * @Method("POST")
     * @Template("NSABundle:Profesor:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NSABundle:Profesor')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("NSABundle:Profesor:edit.html.twig")
     */
